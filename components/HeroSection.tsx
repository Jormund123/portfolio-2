import {Play, Music, Code2, Video, Headphones, Terminal, Film, Speaker, ArrowUpRight} from "lucide-react";
        ...
        <>
            ...
            >
                ...
                <div className="hidden lg:flex items-end justify-start lg:col-start-3">
                    <Link
                        href="https://your-playlist-link.com" // <-- IMPORTANT: Change this URL
                        target="_blank"
                        className="flex items-center gap-2 text-sm text-muted-foreground hover:text-white transition-colors group"
                    >
                        Playlist

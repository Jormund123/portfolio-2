            ...
            <div>
                <div
                    ...
                    <div className="relative z-10 lg:col-start-2 flex flex-col pt-6 text-center lg:text-left">
                        ...
                        <div className="flex-1 flex flex-col mt-12 lg:items-start space-y-8">
                            ...
                            {/* Enhanced Key Stats with Visual Elements */}
                            <div className="grid grid-cols-3 gap-6 text-center lg:text-left relative">
                                ...
                                {/* Interactive Skill Icons positioned to the right */}
